...
import { Sparkles, Palette, Puzzle, Gamepad2, MapPin, Clock, Calendar } from "lucide-react";

const SUBCATEGORIES = [
  { slug: "bambini", label: "Eventi Kids", icon: Gamepad2, color: "#f97316", desc: "Spettacoli, feste e attività per bambini" },
