...
const SUBCATEGORIES = [
  { slug: "spiaggia", label: "Spiaggia", icon: Umbrella, color: "#00FFFF", desc: "Eventi su spiagge e lidi" },
  { slug: "porto", label: "Porto e Marina", icon: Anchor, color: "#00CCCC", desc: "Eventi nei porti e marine" },
  { slug: "costiera", label: "Costiera", icon: Waves, color: "#00E5FF", desc: "Eventi lungo la costa" },
];
  ...
  return (
    <div className="animate-fade-in">
      <div className="relative mb-8 overflow-hidden rounded-3xl">
        <div className="absolute inset-0 bg-[url('/bannertuttialmare.png')] bg-contain bg-center bg-no-repeat" />
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-md" style={{ backgroundColor: "#00FFFF20", color: "#00FFFF" }}>
                      {e.category_name || "Mare"}
                    </span>
                  </div>
                  <h4 className="font-medium text-sm leading-snug line-clamp-2 group-hover:text-cyan-500 transition-colors">{e.title}</h4>
