...
const ACCENT_COLORS = ["#0891b2", "#ef4444", "#ec4899", "#8b5cf6", "#3b82f6", "#06b6d4", "#10b981", "#84cc16"];
    ...
    <div className="max-w-lg mx-auto space-y-6 animate-fade-in">
      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6 text-center">
        <div className="relative inline-block">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[var(--accent)] to-indigo-500 flex items-center justify-center text-white text-2xl font-bold overflow-hidden mx-auto ring-2 ring-[var(--accent)]/20">
        ...
        <div className="flex gap-2 flex-wrap">
          {ACCENT_COLORS.map((c) => (
            <button key={c} onClick={() => setAccent(c)}
              className={`w-8 h-8 rounded-full transition-transform ${(user.accent_color || "#0891b2") === c ? "ring-2 ring-offset-2 ring-[var(--accent)] scale-110 animate-pulse-neon" : "hover:scale-110"}`}
